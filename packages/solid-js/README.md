...
[npm]: https://img.shields.io/npm/v/%40masonry-grid%2Fsolid-js.svg
[npm-url]: https://npmjs.com/package/@masonry-grid/solid-js

[size]: https://deno.bundlejs.com/badge?q=%40masonry-grid%2Fsolid-js
[size-url]: https://bundlejs.com/?q=%40masonry-grid%2Fsolid-js
...
A fast, lightweight, and responsive masonry grid layout library for SolidJS.

- 🪶 **Lightweight**. ~1.7 kB (minified and brotlied). Zero dependencies except SolidJS.
...
```bash
pnpm add @masonry-grid/solid-js
# or
npm i @masonry-grid/solid-js
# or
yarn add @masonry-grid/solid-js
```

## Docs

- [Guides](https://masonry-grid.js.org/guides/prerequisites/)
- [API Reference](https://masonry-grid.js.org/api/solid-js/)
- [Examples](https://masonry-grid.js.org/examples/#solidjs)
