...
<Tabs syncKey='framework'>
  ...
  <TabItem label='Preact' icon='patreon'>
    ...
    1. Install package by running the following command in your terminal:
        ...
        <Tabs syncKey='pkg'>
          <TabItem label='pnpm' icon='pnpm'>
            <Code frame='none' lang='bash' code='pnpm add @masonry-grid/preact' />
          </TabItem>
          <TabItem label='Yarn' icon='seti:yarn'>
            <Code frame='none' lang='sh' code='yarn add @masonry-grid/preact' />
          </TabItem>
          <TabItem label='npm' icon='seti:npm'>
            <Code frame='none' lang='sh' code='npm install @masonry-grid/preact' />
          </TabItem>
        </Tabs>

    2. Now you can import the components and start using them in your Preact project:
    ...
    3. Run your Preact application and see the masonry grid in action!
  ...
  <TabItem label='SolidJS' icon='seti:crystal_embedded'>
    ...
    1. Install package by running the following command in your terminal:
        ...
        <Tabs syncKey='pkg'>
          <TabItem label='pnpm' icon='pnpm'>
            <Code frame='none' lang='bash' code='pnpm add @masonry-grid/solid-js' />
          </TabItem>
          <TabItem label='Yarn' icon='seti:yarn'>
            <Code frame='none' lang='sh' code='yarn add @masonry-grid/solid-js' />
          </TabItem>
          <TabItem label='npm' icon='seti:npm'>
            <Code frame='none' lang='sh' code='npm install @masonry-grid/solid-js' />
          </TabItem>
        </Tabs>

    2. Now you can import the components and start using them in your SolidJS project:
    ...
    3. Run your SolidJS application and see the masonry grid in action!
